...
//Describe group mechanism to group related tests
test.describe('Our Cars Page', () => {
  //? Helpers- groups  two beforeEach into one command
  ...
  //locators are defined as seprate methods to maintain code and ensure focus is
  //  on assertions
  ...
  //you can see in this test that the call to the page sets up the locators and the assertions

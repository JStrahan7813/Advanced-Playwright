...
//class to test regression features across the site, it 
// combines login, navigation and cars page interactions to verify 
// that the user can successfully log in, navigate to the "Our Cars"
//  page, and see the correct details for a specific car, as well 
// as verify that the booking details and user profile show correct
//  information

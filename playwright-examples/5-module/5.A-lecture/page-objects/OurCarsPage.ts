...
/**The code has been evolved from a simple functional Page Object into
 *  a Component-Based Architecture.

The main shift is moving away from purely "raw" Playwright locators
 toward a structured system where UI elements (Buttons, Dropdowns) 
 are treated as their own specialized objects. */
export class OurCarsPage extends BasePage {

  //Now utilizes specialized element classes and scoped, chained 
  // locators for more robust, scalable UI interactions.

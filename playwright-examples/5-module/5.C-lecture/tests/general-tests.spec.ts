...
test.describe('Our Cars Page - Extended Tests', () => {
  ...
  //NOTE HERE I AM USING THE GLOBAL FIXTURES TO ACCESS THE PAGE OBJECTS IN THE TESTS,
  //  THIS ALLOWS ME TO AVOID THE BOILERPLATE OF CREATING NEW INSTANCES
  //  OF THE PAGE OBJECTS IN EACH TEST FILE AND ALSO ENSURES THAT THE
  //  LOGIN STEPS ARE CONSISTENT ACROSS ALL TESTS THAT REQUIRE AUTHENTICATION.
